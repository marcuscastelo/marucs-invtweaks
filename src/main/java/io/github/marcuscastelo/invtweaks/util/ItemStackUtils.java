...
public class ItemStackUtils {
    ...
    public static boolean canStackAddMore(ItemStack existingStack, ItemStack stack) {
        return existingStack.isEmpty() || ItemStack.areItemsEqual(existingStack, stack) && existingStack.isStackable() && existingStack.getCount() < existingStack.getMaxCount() && existingStack.getCount() < 64;
    }
